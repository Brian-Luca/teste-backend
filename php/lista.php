...
$stmt = $conexao->prepare('SELECT * FROM usuario ORDER BY nome LIMIT :current_page, :record_per_page');
...
$_SESSION['num_usuarios'] = $conexao->query('SELECT COUNT(*) FROM usuario')->fetchColumn();
